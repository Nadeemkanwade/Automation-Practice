...
public class AmazonMinSP
{
	public static void main(String[] args)
	{
		...
		System.out.println("Enter Fixed Closing Fees:");
		int fc = sc.nextInt();
		
		System.out.println("Enter Technology fees:");
		int tech = sc.nextInt();
		...
		float min_sp = (((incoming_pr + tech + fc + wc + pp)*hsn)) / 
		...
		if(min_sp > threshold_amt)
		{
			...
			min_sp = (((incoming_pr + tech + fc + wc + pp)*hsn)) / 
			           (1-(((cat_comm + buy_comm )/100)* hsn));
